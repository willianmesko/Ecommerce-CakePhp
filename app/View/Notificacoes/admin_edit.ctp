...
<?php echo $this->Form->create('Notificacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Notificacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Notificacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Notificacao.id'))); ?></li>
